...
from ..models.generator import ADDGenerator
from ..models.encoder import MultilevelAttributesEncoder
...
class BlendSwap(nn.Module):
    def __init__(self):
        ...
        self.G_ema = ADDGenerator(512, 3)
        self.E_ema = MultilevelAttributesEncoder()

        Z_e = iresnet100(pretrained=False, fp16=False)
        Z_e = nn.Sequential(Normalize(0.5, 0.5), Z_e)
        self.Z_e = Z_e

        self.mask_head_ema = nn.Conv2d(64, 1, 1)
